<?php
 ...
 add_action( 'wp_footer', 'mcs_chat_popup');

 function mcs_chat_popup(){
  ...
  $saturday = ($saturday_from ? $saturday_from : "0:00") . "-" . ($saturday_to ? $saturday_to : "23:59");
    ...
    if ($options['opt-button-style'] === '1') {
      $bubbleType = '<button class="mSupport-bubble circle-bubble circle-animation-'. esc_attr($options['circle-animation']).' ">
      ...
      $bubbleType = '<button class="mSupport-bubble bubble mSupport-btn-bg">
      ...
      $bubbleType = '<button class="mSupport-bubble bubble">
      <div class="bubble__icon bubble-animation'. esc_attr($options['circle-animation']).'">
      <span class="bubble__icon--open"><i class="'.esc_html($options['circle-button-icon']).'"></i></span>
      <span class="bubble__icon--close"><i class="'.esc_html($options['circle-button-close']).'"></i></span>
      </div>'.esc_attr($buttonLabel).'</button>';
  } elseif ($options['opt-button-style'] === '4') {
    $bubbleType = '<button class="mSupport-bubble bubble mSupport-btn-rounded mSupport-btn-bg">
    <div class="bubble__icon bubble-animation'. esc_attr($options['circle-animation']).'">
    <span class="bubble__icon--open"><i class="'.esc_html($options['circle-button-icon']).'"></i></span>
    <span class="bubble__icon--close"><i class="'.esc_html($options['circle-button-close']).'"></i></span>
    </div>'.esc_attr($buttonLabel).'</button>';
} elseif ($options['opt-button-style'] === '5') {
  $bubbleType = '<button class="mSupport-bubble bubble mSupport-btn-rounded">
  <div class="bubble__icon bubble-animation'. esc_attr($options['circle-animation']).'">
  <span class="bubble__icon--open"><i class="'.esc_html($options['circle-button-icon']).'"></i></span>
  <span class="bubble__icon--close"><i class="'.esc_html($options['circle-button-close']).'"></i></span>
  </div>'.esc_attr($buttonLabel).'</button>';
} elseif ($options['opt-button-style'] === '6') {
  $bubbleType = '<button class="mSupport-bubble bubble mSupport-btn-bg bubble-transparent">
  <div class="bubble__icon bubble-animation'. esc_attr($options['circle-animation']).'">
  <span class="bubble__icon--open"><i class="'.esc_html($options['circle-button-icon']).'"></i></span>
  <span class="bubble__icon--close"><i class="'.esc_html($options['circle-button-close']).'"></i></span>
  </div>'.esc_attr($buttonLabel).'</button>';
} elseif ($options['opt-button-style'] === '7') {
  $bubbleType = '<button class="mSupport-bubble bubble  bubble-transparent">
  <div class="bubble__icon bubble-animation'. esc_attr($options['circle-animation']).'">
  <span class="bubble__icon--open"><i class="'.esc_html($options['circle-button-icon']).'"></i></span>
  <span class="bubble__icon--close"><i class="'.esc_html($options['circle-button-close']).'"></i></span>
  </div>'.esc_attr($buttonLabel).'</button>';
}  elseif ($options['opt-button-style'] === '8') {
  $bubbleType = '<button class="mSupport-bubble bubble mSupport-btn-bg mSupport-btn-rounded bubble-transparent">
  <div class="bubble__icon bubble-animation'. esc_attr($options['circle-animation']).'">
  <span class="bubble__icon--open"><i class="'.esc_html($options['circle-button-icon']).'"></i></span>
  <span class="bubble__icon--close"><i class="'.esc_html($options['circle-button-close']).'"></i></span>
  </div>'.esc_attr($buttonLabel).'</button>';
} elseif ($options['opt-button-style'] === '9') {
  $bubbleType = '<button class="mSupport-bubble bubble mSupport-btn-rounded bubble-transparent">
  <div class="bubble__icon bubble-animation'. esc_attr($options['circle-animation']).'">
  <span class="bubble__icon--open"><i class="'.esc_html($options['circle-button-icon']).'"></i></span>
  <span class="bubble__icon--close"><i class="'.esc_html($options['circle-button-close']).'"></i></span>
  </div>'.esc_attr($buttonLabel).'</button>';
...
?>
  ...
  <div class="mSupport mSupport-<?php if (isset($options['bubble-visibility'])) { echo esc_attr($options['bubble-visibility']);}; ?>-only <?php if ($options['autoshow-popup']) : ?>mSupport-show<?php endif; ?> <?php if($options['bubble-style'] === 'dark') : ?>dark-mode <?php elseif($options['bubble-style'] === 'night') : ?> night-mode<?php endif; ?> <?php if($options['bubble-position'] === 'left') { ?>mSupport-left<?php } ?>">
      <?php echo $bubbleType;?>
      <div
        class="mSupport__popup animation<?php if($options['select-animation'] === 'random') : ?><?php echo esc_attr($random) ?><?php else : ?><?php echo esc_attr($options['select-animation']); ?><?php endif; ?> chat-availability"
      ...
      >
        <div class="mSupport__popup--header <?php if($options['header-content-position'] === 'center') { ?>header-center<?php } ?>">
          <div class="image">
